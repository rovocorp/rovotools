...
const SAMPLES: Record<string, Record<string, unknown>> = {
  ...
  "utm-builder": { baseUrl: "https://example.com/page", source: "newsletter", medium: "email", campaign: "launch", term: "", content: "" },
  "serp-preview": { title: "Example Domain Title Here", pageUrl: "https://example.com", description: "A concise description of the example page for testing." },
  "schema-validator": { markup: '{"@context":"https://schema.org","@type":"Article","headline":"Hi"}' },
  "meta-tag-analyzer": { html: "<html><head><title>Example Title</title></head><body></body></html>" },
  "robots-txt-checker": { content: "User-agent: *\nDisallow: /private\n" },
  "seo-checker": { html: "<html><head><title>Example Title</title></head><body><h1>Hello</h1></body></html>" },
  "open-graph-checker": { html: '<html><head><meta property="og:title" content="T"><meta property="og:description" content="D"><meta property="og:image" content="https://example.com/og.png"></head><body></body></html>' },
  "sitemap-checker": { xml: '<urlset><url><loc>https://example.com/a</loc><lastmod>2026-01-01</lastmod></url><url><loc>https://example.com/b</loc></url></urlset>' },
  "tag-detector": { html: "<html><head></head><body></body></html>" },
  "performance-analyzer": { html: "<html><head><title>T</title></head><body><p>Hi</p></body></html>" },
