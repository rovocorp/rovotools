...
export const DARK_COLORS: SemanticColors = {
  background: NEUTRAL.zinc950,
  surface: "#0F1E3C",
  surfaceAlt: "#1A2B4D",
  foreground: "#F1F5F9",
  mutedForeground: "#93A1B8",
  border: "#1E2F52",
  ring: BRAND_PRIMARY_DARK.toLowerCase(),
  primary: BRAND_PRIMARY_DARK.toLowerCase(),
  primaryHover: BRAND_PRIMARY_DARK_HOVER.toLowerCase(),
  primaryForeground: NEUTRAL.white,
  secondary: "#13294F",
  secondaryForeground: "#7AA8FF",
  accent: "#2DD4A7",
  accentForeground: NEUTRAL.zinc950,
  destructive: "#F87171",
  destructiveForeground: NEUTRAL.zinc950,
  success: "#34D399",
