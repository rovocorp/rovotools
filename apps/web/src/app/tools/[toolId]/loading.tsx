export default function ToolLoading(): React.ReactElement {
  return (
    <div role="status" aria-busy="true" aria-label="Loading tool" className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6">
