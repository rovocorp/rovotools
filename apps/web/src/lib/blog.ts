...
export const BLOG_POSTS: ReadonlyArray<BlogPost> = [
  ...
  },
  {
    ...
    date: "2026-07-14",
    category: "Finance",
    relatedTools: ["loan-payment-calculator", "emi-calculator", "compound-interest-calculator"],
    body: [
      ...
      "The standard amortising-loan formula is M = P × r(1+r)^n / ((1+r)^n − 1), where P is the principal, r the monthly rate and n the number of payments. RovoTools applies exactly this formula in the Loan Payment Calculator and the EMI Calculator.",
      ...
      "Try this experiment: enter your loan in the EMI Calculator, note the total interest, then reduce the term by two years and compare. The monthly rise is usually smaller than people expect, while the interest saving is large.",
  ...
  },
  {
    ...
    date: "2026-09-12",
    category: "Finance",
    relatedTools: ["compound-interest-calculator", "emi-calculator", "roi-calculator"],
    body: [
      ...
      "Debt is compounding in reverse: credit-card balances grow by the same exponential curve. The EMI Calculator shows how much of each payment is interest, which is why overpaying early saves the most.",
    ],
  },
  {
