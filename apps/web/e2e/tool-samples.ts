...
export const TOOL_SAMPLES: Record<string, Record<string, string>> = {
  ...
  "serp-preview": {
    title: "Example Domain Title Here",
    pageUrl: "https://example.com",
    description: "A concise description of the example page for testing.",
  },
  ...
  "open-graph-checker": {
    html: '<html><head><meta property="og:title" content="T"><meta property="og:description" content="D"><meta property="og:image" content="https://example.com/og.png"></head><body></body></html>',
  },
  "sitemap-checker": {
    xml: '<urlset><url><loc>https://example.com/a</loc><lastmod>2026-01-01</lastmod></url><url><loc>https://example.com/b</loc></url></urlset>',
  },
...
export const EXPECTED_SUBSTRINGS: Record<string, Array<string>> = {
  ...
  "utm-builder": ["utm_source=newsletter"],
  "serp-preview": ["good"],
  "schema-validator": ["Article"],
  "meta-tag-analyzer": ["Missing meta description"],
  "robots-txt-checker": ["Sitemap"],
  "seo-checker": ["Missing meta description"],
  "open-graph-checker": ["og.png"],
